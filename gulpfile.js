...
const downloadSearchApp = require('./gulp.d/tasks/download-search-app')
...
const downloadTask = createTask({
  name: 'download',
  desc: 'Download Search app',
  call: downloadSearchApp,
})
...
const buildTask = createTask({
  ...
  call: series(downloadTask, task.build(
    srcDir,
    destDir,
